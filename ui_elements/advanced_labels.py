...
class Labels:
    ...
    def set_text_labels_tooltips(self) -> None:
        ...
        if isinstance(logging_level_label, QLabel):
        ...
        if isinstance(schema_columns_label, QLabel):
        ...
        if isinstance(path_to_logs_label, QLabel):
    ...
    def set_number_labels_tooltips(self) -> None:
        ...
        if isinstance(comparing_step_label, QLabel):
        ...
        if isinstance(depth_report_check_label, QLabel):
        ...
        if isinstance(retry_attempts_label, QLabel):
        ...
        if isinstance(table_timeout_label, QLabel):
        ...
        if isinstance(strings_amount_label, QLabel):
