...
class ElementPositions:
    ...
    def locate_elements(self, labels, line_edits, checkboxes, buttons, radio_buttons) -> None:
        ...
        self.grid.addWidget(checkboxes.check_schema, 10, 0)
        self.grid.addWidget(checkboxes.fail_fast, 11, 0)
        self.grid.addWidget(checkboxes.check_reports, 10, 1)
        self.grid.addWidget(checkboxes.check_entities, 11, 1)
        self.grid.addWidget(checkboxes.use_dataframes, 10, 2)
