...
class ElementPositions:
    ...
    def locate_other(self, checkboxes, buttons, radio_buttons) -> None:
        ...
        self.grid.addWidget(radio_buttons.get('day_summary'), 7, 3)
        self.grid.addWidget(radio_buttons.get('section_summary'), 8, 3)
        self.grid.addWidget(radio_buttons.get('detailed'), 9, 3)
