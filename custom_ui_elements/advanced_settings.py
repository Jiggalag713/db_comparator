...
class AdvancedSettingsItem(QDialog):
    ...
    def __init__(self, configuration):
        super().__init__()
        self.ui = UIElements()
        self.setLayout(self.ui.positions.grid)
        self.default_values = configuration.default_values
        self.advanced_logic = AdvancedWindowLogic(self, self.ui, self.default_values)
        self.ui.buttons.btn_ok.clicked.connect(self.advanced_logic.ok_pressed)
        self.ui.buttons.btn_cancel.clicked.connect(self.advanced_logic.cancel_pressed)
        self.ui.buttons.btn_reset.clicked.connect(self.advanced_logic.set_default)
